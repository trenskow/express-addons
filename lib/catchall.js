...
module.exports = exports = (handlerRoute) => {
	...
	if (Router.isCatchAllInstalled) return;

	Object.defineProperty(Router, 'isCatchAllInstalled', {
		value: true,
		enumerable: true,
		writable: false
	});
	
	// We add a special catch all route that allows to catch non-allowed methods.
